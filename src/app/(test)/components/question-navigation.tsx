    ...
    <div className="bg-white p-6 rounded-lg shadow-sm w-1/3 border">
      ...
      <div className="flex flex-col gap-2 justify-start mt-4">
        <div className="w-full flex flex-row gap-2 items-center">
          <span className="w-9 h-9 bg-green-600/80 rounded-lg"></span> - Answered
        </div>
        <div className="w-full flex flex-row gap-2 items-center">
          <span className="w-9 h-9 bg-red-500/80 rounded-lg"></span> - Not answered
        </div>
        <div className="w-full flex flex-row gap-2 items-center">
          <span className="w-9 h-9 bg-indigo-600/80 rounded-lg"></span> - Answered and marked for review
        </div>
        <div className="w-full flex flex-row gap-2 items-center">
          <span className="w-9 h-9 bg-amber-600/90 rounded-lg"></span> - Unanswered and marked for review
        </div>
        <div className="w-full flex flex-row gap-2 items-center">
          <span className="w-9 h-9 bg-gray-300 rounded-lg"></span> - Not attended
        </div>
      </div>
    </div>
  );
